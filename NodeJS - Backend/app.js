...
var db1 ='mongodb://ArpitDave:arpitdave1997@projectdatabase-shard-00-00-wwv7d.mongodb.net:27017,projectdatabase-shard-00-01-wwv7d.mongodb.net:27017,projectdatabase-shard-00-02-wwv7d.mongodb.net:27017/test?ssl=true&replicaSet=ProjectDatabase-shard-0&authSource=admin&retryWrites=true';
...
app.post('/skills',checkAuth,function(req,res)
{
	...
	newTechnology.skill=req.body.skill;
	
	newTechnology.save(function(err,technology)

	{ if(err)
		{
			res.send('error saving technology' + err);
